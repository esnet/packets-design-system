...
import { PktsSpacer } from "@esnet/packets-ui-react";
import { SpacingDocSquare } from "doc-ui";

const meta: Meta<typeof PktsSpacer> = {
  title: "Components/PktsSpacer",
  component: PktsSpacer,
  tags: ["autodocs"],
  argTypes: {
    type: {
      control: { type: "radio" },
...
type Story = StoryObj<typeof PktsSpacer>;
