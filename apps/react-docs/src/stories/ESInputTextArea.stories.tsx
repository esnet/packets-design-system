...
import { ESInputTextArea } from "@esnet/packets-ui-react";

const meta: Meta<typeof ESInputTextArea> = {
  title: "Components/ESInputTextArea",
  component: ESInputTextArea,
  tags: ["autodocs"],
  argTypes: {
    variant: {
      control: { type: "radio" },
...
type Story = StoryObj<typeof ESInputTextArea>;
