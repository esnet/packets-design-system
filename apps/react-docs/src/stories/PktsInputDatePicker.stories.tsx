...
import { PktsInputDatePicker } from "@esnet/packets-ui-react/src/components/PktsInputDatePicker/PktsInputDatePicker.tsx";

const meta: Meta<typeof PktsInputDatePicker> = {
  title: "Components/PktsInputDatePicker",
  component: PktsInputDatePicker,
  tags: ["autodocs"],
  argTypes: {
    type: {
      control: "radio",
...
type Story = StoryObj<typeof PktsInputDatePicker>;
