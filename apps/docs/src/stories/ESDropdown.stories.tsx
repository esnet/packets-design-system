  ...
  args: {
    ...
    children: [
      <ESButtonGroup direction="vertical">
        <ESButton style={{ minWidth: 300 }} variant="primary" type="button">
          Navigate to Profile
        </ESButton>
        <ESButton style={{ minWidth: 300 }} variant="secondary" type="button">
          Navigate to Billing
        </ESButton>
        <ESButton style={{ minWidth: 300 }} variant="secondary" type="button">
          Navigate to Settings
        </ESButton>
        <ESButton style={{ minWidth: 300 }} variant="tertiary" type="button">
