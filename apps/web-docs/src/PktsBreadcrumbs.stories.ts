...
import { PktsBreadcrumbs } from "@esnet/packets-ui-web";

const meta: Meta<typeof PktsBreadcrumbs> = {
  title: 'Components/PktsBreadcrumbs',
  component: PktsBreadcrumbs.tagName,
  tags: ['autodocs'],
  argTypes: {
    crumbs: {
      control: "object",
  ...
  render: (args) => {
    const breadcrumbs = document.createElement(PktsBreadcrumbs.tagName) as InstanceType<typeof PktsBreadcrumbs>;
