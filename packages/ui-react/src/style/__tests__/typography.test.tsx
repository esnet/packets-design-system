...
test.describe("RichText", () => {
  ...
  themes.forEach((theme) => {
        ...
        <ComponentTestBox
          ...
          component={
            <div className={theme}>
              ...
              <h1 className="display2 branded">
                (Used in ESTitleSection) Branded
              </h1>
            </div>
          }
        />,
    ...
    test(`${theme}-anchor`, async ({ mount }) => {
        ...
        <ComponentTestBox
          ...
          component={
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <a href="/" data-testid="hover">
                Example Link (hover), ({theme})
              </a>
              <a href="/" data-testid="focus">
                Example Link (focus), ({theme})
              </a>
      ...
      await component.getByTestId("focus").focus();
      await expect(component).toHaveScreenshot();
    });
    ...
    test(`${theme}-footer`, async ({ mount }) => {
      const component = await mount(
        <ComponentTestBox
          theme={theme}
          component={<footer>Footer text. Copyright text.</footer>}
        />,
      );
      await expect(component).toHaveScreenshot();
    });
    ...
    test(`${theme}-caption`, async ({ mount }) => {
      const component = await mount(
        <ComponentTestBox
          theme={theme}
          component={<figcaption>Caption Text. Used in ESFigure.</figcaption>}
        />,
      );
      await expect(component).toHaveScreenshot();
    });
    ...
    test(`${theme}-inline-code`, async ({ mount }) => {
      ...
      const component = await mount(
        <ComponentTestBox theme={theme} component={<code>{code}</code>} />,
      );
      await expect(component).toHaveScreenshot();
    });
