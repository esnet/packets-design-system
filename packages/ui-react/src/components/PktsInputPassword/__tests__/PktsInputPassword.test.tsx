  ...
  ["light", "dark"].forEach((theme: any) => {
    test(`PktsInputPassword-variants-${theme}`, async ({ mount }) => {
            ...
            >
              ...
              >
                <div style={{ width: "160px" }}>
                  <PktsInputPassword placeholder="password" />
                </div>
                <div id="hover-default" style={{ width: "160px" }}>
                  <PktsInputPassword defaultValue="password" />
                </div>
                <div id="focus-default" style={{ width: "160px" }}>
                  <PktsInputPassword defaultValue="password" />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputPassword placeholder="password" disabled />
                </div>
              </div>
              <div
                style={{ display: "flex", gap: "8px", alignItems: "center" }}
              >
                <div style={{ width: "160px" }}>
                  <PktsInputPassword variant="branded" placeholder="password" />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputPassword
                    variant="branded"
              ...
              >
                <div style={{ width: "160px" }}>
                  <PktsInputPassword error placeholder="password" />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputPassword error defaultValue="password" />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputPassword error defaultValue="password" />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputPassword error placeholder="password" disabled />
                </div>
              </div>
            </div>
          }
      ...
      await expect(component).toHaveScreenshot(
        `PktsInputPassword-variants-${theme}.png`,
      );
    });
  });
