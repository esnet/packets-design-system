...
export interface PktsInputRowProps extends ComponentPropsWithoutRef<"label"> {
  /** Text label shown above the input. */
  label: string;
  /** The `PktsInput*` element. Recommended to not put anything else, except the input element. */
