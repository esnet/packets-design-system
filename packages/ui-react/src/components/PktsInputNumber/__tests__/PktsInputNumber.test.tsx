  ...
  ["light", "dark"].forEach((theme: any) => {
    test(`PktsInputNumber-variants-${theme}`, async ({ mount }) => {
            ...
            >
              ...
              >
                <div style={{ width: "160px" }}>
                  <PktsInputNumber placeholder="0" />
                </div>
                <div id="hover-default" style={{ width: "160px" }}>
                  <PktsInputNumber defaultValue={10} />
                </div>
                <div id="focus-default" style={{ width: "160px" }}>
                  <PktsInputNumber defaultValue={10} />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputNumber placeholder="0" disabled />
                </div>
              </div>
              <div
                style={{ display: "flex", gap: "8px", alignItems: "center" }}
              >
                <div style={{ width: "160px" }}>
                  <PktsInputNumber variant="branded" placeholder="0" />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputNumber variant="branded" defaultValue={10} />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputNumber variant="branded" defaultValue={10} />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputNumber variant="branded" placeholder="0" disabled />
                </div>
              </div>
              <div
                style={{ display: "flex", gap: "8px", alignItems: "center" }}
              >
                <div style={{ width: "160px" }}>
                  <PktsInputNumber error placeholder="0" />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputNumber error defaultValue={10} />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputNumber error defaultValue={10} />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputNumber error placeholder="0" disabled />
                </div>
              </div>
            </div>
          }
      ...
      await expect(component).toHaveScreenshot(
        `PktsInputNumber-variants-${theme}.png`,
      );
    });
  });
