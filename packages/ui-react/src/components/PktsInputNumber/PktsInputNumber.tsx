 ...
 */
const PktsInputNumber: React.FC<PktsInputNumberProps> = ({
  variant = "primary",
  error = false,
  defaultValue = "0",
  onAddClick,
  ...
  const classNames = clsx("pkts-input-number", className);
...
PktsInputNumber.displayName = "PktsInputNumber";

export default PktsInputNumber;
