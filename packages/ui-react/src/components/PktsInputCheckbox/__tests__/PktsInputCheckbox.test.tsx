...
test.describe("PktsInputCheckbox", () => {
    ["light", "dark"].forEach((theme: any) => {
        test(`PktsInputCheckbox-variants-${theme}`, async ({ mount }) => {
                ...
                <ComponentTestBox theme={theme} component={
                    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                        <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                            ...
                            <div id="hover-unchecked"><PktsInputCheckbox variant="primary" /></div>
                            <div id="focus-unchecked"><PktsInputCheckbox variant="primary" /></div>
            ...
            await component.locator("#focus-unchecked input[type='checkbox']").focus();
            await component.locator("#hover-unchecked input[type='checkbox']").hover();
            await expect(component).toHaveScreenshot(`PktsInputCheckbox-variants-${theme}.png`);
        });
    });
});
