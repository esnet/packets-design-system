  ...
  ["light", "dark"].forEach((theme: any) => {
    test(`PktsInputEmail-variants-${theme}`, async ({ mount }) => {
            ...
            >
              ...
              >
                <div style={{ width: "160px" }}>
                  <PktsInputEmail placeholder="test@email.com" />
                </div>
                <div id="hover-default" style={{ width: "160px" }}>
                  <PktsInputEmail defaultValue="test@email.com" />
                </div>
                <div id="focus-default" style={{ width: "160px" }}>
                  <PktsInputEmail defaultValue="test@email.com" />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputEmail placeholder="test@email.com" disabled />
                </div>
              </div>
              <div
                style={{ display: "flex", gap: "8px", alignItems: "center" }}
              ...
              >
                <div style={{ width: "160px" }}>
                  <PktsInputEmail error placeholder="test@email.com" />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputEmail error defaultValue="test@email.com" />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputEmail error defaultValue="test@email.com" />
                </div>
                <div style={{ width: "160px" }}>
                  <PktsInputEmail error placeholder="test@email.com" disabled />
                </div>
              </div>
            </div>
          }
      ...
      await expect(component).toHaveScreenshot(
        `PktsInputEmail-variants-${theme}.png`,
      );
    });
  });
