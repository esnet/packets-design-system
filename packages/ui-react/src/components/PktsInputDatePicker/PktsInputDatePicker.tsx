...
import PktsInputDatePickerDate from "./PktsInputDatePickerDate/PktsInputDatePickerDate";
import PktsInputDatePickerTime from "./PktsInputDatePickerTime/PktsInputDatePickerTime";
 ...
 *
 * ```ts
 * interface PktsInputDatePickerDateSettings {
 ...
 *
 * interface PktsInputDatePickerTimeSettings {
 ...
 * ```
 */
export function PktsInputDatePicker({
  type = "daterange",
  value,
  onChange,
  rangeEndValue,
  ...
  return <div className="pkts-input-date-picker">{inputTypeMenus}</div>;
}

PktsInputDatePicker.displayName = "PktsInputDatePicker";

export default PktsInputDatePicker;
