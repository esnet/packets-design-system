import type { ESInputDatePickerDateSettings } from "./ESInputDatePicker.types";
import {
  flattenedDateGrid,
  getMonthName,
  monthNames,
...
export class ESInputDatePickerDate extends HTMLElement {
  static tagName = "es-input-date-picker-date";
  ...
  public settings?: ESInputDatePickerDateSettings;
  ...
  protected render(): void {
    ...
    this.innerHTML = `
      <div class="es-input-date-picker-date">
...
customElements.define(ESInputDatePickerDate.tagName, ESInputDatePickerDate);
