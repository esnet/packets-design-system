...
export class ESInputDatePickerTime extends HTMLElement {
  static tagName = "es-input-date-picker-time";
  ...
  public settings?: ESInputDatePickerTimeSettings;
  ...
  protected render(): void {
    ...
    this.innerHTML = `
      <div class="es-input-date-picker-time">
        ${wheels.join("")}
      </div>
    `;
...
customElements.define(ESInputDatePickerTime.tagName, ESInputDatePickerTime);
