...
} from "../ESInputDatePicker/ESInputDatePicker.types";
...
export class ESInputDate extends HTMLElement implements ESInputDateProps {
  static tagName = "es-input-date";
  ...
  private _attachEventListeners(): void {
    ...
    this.pickerEl = this.querySelector("es-input-date-picker") as HTMLElement;
    if (this.pickerEl) {
...
customElements.define(ESInputDate.tagName, ESInputDate);
