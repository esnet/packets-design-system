...
export class PktsInputDateRange
  extends HTMLElement
  implements PktsInputDateRangeProps
{
  ...
  private _attachEventListeners(): void {
    ...
    this.pickerEl = this.querySelector("pkts-input-date-picker") as any;
    if (this.pickerEl) {
  ...
  protected render(): void {
    ...
    const className = ["pkts-input-date-range"];
...
customElements.define(PktsInputDateRange.tagName, PktsInputDateRange);
