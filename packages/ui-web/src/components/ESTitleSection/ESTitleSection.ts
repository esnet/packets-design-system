...
export class ESTitleSection extends SlottedComponent implements ESTitleSectionProps {
  static tagName = "es-title-section";
  ...
  protected _renderInitial(): void {
    this.innerHTML = `
      <${ESModule.tagName} class="titleLayout">
    ...
    this.moduleEl = this.querySelector(ESModule.tagName)!;
...
customElements.define(ESTitleSection.tagName, ESTitleSection);
