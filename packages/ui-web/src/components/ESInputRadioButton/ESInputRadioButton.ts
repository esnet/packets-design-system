...
export class ESInputRadioButton extends HTMLElement implements ESInputRadioButtonProps {
    static tagName = "es-input-radio";
...
customElements.define(ESInputRadioButton.tagName, ESInputRadioButton);
