...
export class PktsInputDatePicker
  extends HTMLElement
  implements PktsInputDatePickerProps
{
  static tagName = "pkts-input-date-picker";
  ...
  attributeChangedCallback(
    ...
    if (oldVal !== newVal) {
      ...
      if (!this.querySelector(".pkts-input-date-picker")) {
        this.render();
      } else {
  ...
  protected render(): void {
    ...
    const className = ["pkts-input-date-picker"];
    ...
    switch (type) {
      case "time":
        innerContent = `<pkts-input-date-picker-time></pkts-input-date-picker-time>`;
        break;
      case "datetime":
        innerContent = `
          <pkts-input-date-picker-date></pkts-input-date-picker-date>
          <pkts-input-date-picker-time></pkts-input-date-picker-time>
        `;
        break;
      case "daterange":
        innerContent = `<pkts-input-date-picker-date is-date-range="true"></pkts-input-date-picker-date>`;
        break;
      case "date":
      default:
        innerContent = `<pkts-input-date-picker-date></pkts-input-date-picker-date>`;
        break;
    }
...
customElements.define(PktsInputDatePicker.tagName, PktsInputDatePicker);
