...
import { ESInputDateRangeProps } from "../ESInputDateRange.types";
import ESInputDateRange from "../ESInputDateRange";
test.describe("ESInputDateRange", () => {
  const testTodayDate = new Date(2025, 8, 15);
  const { testTable, themes }: ComponentTestTableType<ESInputDateRangeProps> = {
    testTable: [
      {
        name: "daterange",
        props: {},
